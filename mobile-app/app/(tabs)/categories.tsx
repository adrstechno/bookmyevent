...
const CANONICAL_SERVICE_CARDS: ServiceCard[] = [
  {
    id: "wedding-band-party-services",
    title: "Band party services",
    description: "Band party services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-disco-light",
    title: "disco light",
    description: "we are providing best disco light services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-dj-and-sound-system",
    title: "dj and sound system",
    description: "we are provieding the best sound and dj system",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-entry-and-pyro-ballon-decorestion",
    title: "Entry and pyro ballon decorestion",
    description: "Entry and pyro ballon decorestion services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    ...
    title: "fireworks",
    description: "we are provieding the best fireworks services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-flower-decorestion",
    title: "flower decorestion",
    description: "we provied flower decorestion",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-ketars",
    title: "Ketars",
    description: "we provied Ketars services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-mehendi-service",
    title: "Mehendi Service",
    description:
      "Our Bridal Mehendi services are designed to make your wedding even more special. We create stunning, personalized designs that reflect tradition, elegance, and your unique style.",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-musical-accompaniment-arkestra",
    title: "Musical Accompaniment / Arkestra",
    description: "we are provieding best musical Accompaniment services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-pandit-ji",
    title: "Pandit ji",
    description: "Pandit ji",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-parlor-service",
    title: "parlor service",
    description: "we are providing mackup and parlor services",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-party-hall-and-garden",
    title: "Party Hall and Garden",
    description: "we are provieding a good location and space for your event",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-security-crowd-management-volunteer",
    title: "Security & Crowd Management [Volunteer]",
    description: "Volunteers ensuring safe and organized crowd flow.",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-tent-egency-and-light",
    title: "Tent Egency and light",
    description:
      "we are provieding the best light and tent service for your event",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-traditional-turban-pagdi-tying-service",
    title: "Traditional Turban (Pagdi) Tying Service",
    description: "Royal pagdi styling for a traditional look.",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-wedding-carriage-baggi-service",
    title: "Wedding Carriage (Baggi) Service",
    description: "Grand royal entry with decorated wedding carriage.",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },
  {
    id: "wedding-wedding-photography-videography",
    title: "Wedding Photography & Videography",
    description: "Creative photography for unforgettable events",
    categoryId: "wedding",
    categoryName: "Wedding Event",
  },

  {
    id: "birthday-band-party-services",
    title: "Band party services",
    description: "Band party services",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  },
  {
    id: "birthday-birthday-cake-custom-cakes",
    title: "Birthday Cake & Custom Cakes",
    description: "Delicious cakes crafted for your special celebration.",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  },
  {
    id: "birthday-dj-and-sound-system",
    title: "dj and sound system",
    description: "we are provieding the best sound and dj system",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  ...
  {
    id: "birthday-entry-and-pyro-ballon-decorestion",
    title: "Entry and pyro ballon decorestion",
    description: "Entry and pyro ballon decorestion services",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  ...
  {
    id: "birthday-flower-decorestion",
    title: "flower decorestion",
    description: "we provied flower decorestion",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  ...
  {
    id: "birthday-fun-entertainment-services",
    title: "Fun & Entertainment Services",
    description: "Fun-filled activities for an unforgettable party.",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  },
  {
  ...
  {
    id: "birthday-musical-accompaniment-arkestra",
    title: "Musical Accompaniment / Arkestra",
    description: "we are provieding best musical Accompaniment services",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  ...
  {
    id: "birthday-party-hall-and-garden",
    title: "Party Hall and Garden",
    description: "we are provieding a good location and space for your event",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  ...
  {
    id: "birthday-tent-egency-and-light",
    title: "Tent Egency and light",
    description:
      "we are provieding the best light and tent service for your event",
    categoryId: "birthday",
  ...
  {
    id: "birthday-wedding-photography-videography",
    title: "Wedding Photography & Videography",
    description: "Creative photography for unforgettable events",
    categoryId: "birthday",
    categoryName: "Birthday Party Event",
  ...
  {
    id: "kitty-dj-and-sound-system",
    title: "dj and sound system",
    description: "we are provieding the best sound and dj system",
    categoryId: "kitty",
    categoryName: "Kity Party Event",
  },
  {
    id: "kitty-ketars",
    title: "Ketars",
  ...
  {
    id: "kitty-party-hall-and-garden",
    title: "Party Hall and Garden",
    description: "we are provieding a good location and space for your event",
    categoryId: "kitty",
    categoryName: "Kity Party Event",
  ...
  {
    id: "kitty-tent-egency-and-light",
    title: "Tent Egency and light",
    description:
      "we are provieding the best light and tent service for your event",
    categoryId: "kitty",
  ...
  {
    id: "kitty-wedding-photography-videography",
    title: "Wedding Photography & Videography",
    description: "Creative photography for unforgettable events",
    categoryId: "kitty",
    categoryName: "Kity Party Event",
  ...
  {
    id: "bhagwat-band-party-services",
    title: "Band party services",
    description: "Band party services",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  },
  {
    id: "bhagwat-dj-and-sound-system",
    title: "dj and sound system",
    description: "we are provieding the best sound and dj system",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  ...
  {
    id: "bhagwat-entry-and-pyro-ballon-decorestion",
    title: "Entry and pyro ballon decorestion",
    description: "Entry and pyro ballon decorestion services",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  ...
  {
    id: "bhagwat-musical-accompaniment-arkestra",
    title: "Musical Accompaniment / Arkestra",
    description: "we are provieding best musical Accompaniment services",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  ...
  {
    id: "bhagwat-party-hall-and-garden",
    title: "Party Hall and Garden",
    description: "we are provieding a good location and space for your event",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  ...
  {
    id: "bhagwat-security-crowd-management-volunteer",
    title: "Security & Crowd Management [Volunteer]",
    description: "Volunteers ensuring safe and organized crowd flow.",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  ...
  {
    id: "bhagwat-tent-egency-and-light",
    title: "Tent Egency and light",
    description:
      "we are provieding the best light and tent service for your event",
    categoryId: "bhagwat",
  ...
  {
    id: "bhagwat-wedding-photography-videography",
    title: "Wedding Photography & Videography",
    description: "Creative photography for unforgettable events",
    categoryId: "bhagwat",
    categoryName: "Bhagwat Katha Event",
  ...
  {
    id: "office-parlor-service",
    title: "parlor service",
    description: "we are providing mackup and parlor services",
    categoryId: "office",
    categoryName: "Office Seminar and Public Confrence",
  },
  {
    id: "office-party-hall-and-garden",
    title: "Party Hall and Garden",
    description: "we are provieding a good location and space for your event",
    categoryId: "office",
    categoryName: "Office Seminar and Public Confrence",
  ...
  {
    id: "office-security-crowd-management-volunteer",
    title: "Security & Crowd Management [Volunteer]",
    description: "Volunteers ensuring safe and organized crowd flow.",
    categoryId: "office",
    categoryName: "Office Seminar and Public Confrence",
  ...
  {
    id: "office-tent-egency-and-light",
    title: "Tent Egency and light",
    description:
      "we are provieding the best light and tent service for your event",
    categoryId: "office",
  ...
  {
    id: "office-wedding-photography-videography",
    title: "Wedding Photography & Videography",
    description: "Creative photography for unforgettable events",
    categoryId: "office",
    categoryName: "Office Seminar and Public Confrence",
...
const ServiceCardItem = memo(function ServiceCardItem({
  ...
  const isRomanticCategory = /wedding|engagement|romantic/i.test(
    card.categoryName,
  );
  ...
  return (
    ...
    >
      ...
      <View style={[styles.categoryBadge, { backgroundColor: badgeBg }]}>
        <ThemedText
          style={[styles.categoryBadgeText, { color: palette.onPrimary }]}
          numberOfLines={1}
        >
          {card.categoryName}
        </ThemedText>
      ...
      <View
        style={[
          styles.serviceCardFooter,
          { backgroundColor: palette.surfaceBg },
        ]}
      >
        <ThemedText
          style={[styles.serviceCardTitle, { color: palette.text }]}
          numberOfLines={1}
        >
          {card.title}
        </ThemedText>
        <View
          style={[styles.titleUnderline, { backgroundColor: palette.accent }]}
        />
        <ThemedText
          style={[styles.serviceCardDescription, { color: palette.subtext }]}
          numberOfLines={2}
        >
          {card.description}
        </ThemedText>
        ...
        >
          <View style={styles.viewButtonContent}>
            <ThemedText
              style={[styles.viewButtonText, { color: palette.onPrimary }]}
            >
              View Vendors
            </ThemedText>
            <View
              style={[
                styles.viewButtonIconWrap,
...
export default function CategoriesTabScreen() {
  ...
  const [allCards, setAllCards] = useState<ServiceCard[]>(
    CANONICAL_SERVICE_CARDS,
  );
  const [apiCategories, setApiCategories] =
    useState<CategoryChip[]>(CATEGORY_CHIPS); // Dynamic categories from API, fallback to hardcoded
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        console.log(
          "[Categories] Service categories response:",
          categoryResponse.data,
        );

        const categoryRows = toRows(categoryResponse.data);
        console.log(
          "[Categories] Parsed category rows:",
          categoryRows.length,
          "items",
        );
        ...
        const activeCategories = categoryRows
          .filter((row) => {
            ...
            if (!isActive) {
              console.log(
                "[Categories] Skipping inactive category:",
          ...
          .map((row, idx) => {
            ...
            if (!categoryId) {
              console.warn(
                `[Categories] Row ${idx} missing category ID (category_id, service_id, id all missing/empty)`,
              );
              return null;
            }

            const categoryName = String(
              row.category_name ?? row.name ?? "Service",
            );
            const image =
            ...
            console.log(
              `[Categories] Active category: id=${categoryId}, name=${categoryName}, hasImage=${Boolean(image)}`,
            );
        ...
        console.log(
          "[Categories] Total active categories:",
        ...
        if (activeCategories.length === 0) {
          console.warn(
            "[Categories] No active categories from API. Using fallback hardcoded services.",
          );
          if (isMounted) {
            setLoadError(
              "No active categories available right now. Showing saved services.",
            );
        ...
        const dynamicCategories: CategoryChip[] = activeCategories.map(
          (cat) => ({
            id: cat.id,
            name: cat.name,
            image: cat.image,
        ...
        if (isMounted) {
          ...
          console.log(
            "[Categories] Updating category chips from API:",
        ...
        console.log(
          "[Categories] Fetching subservices for",
          activeCategories.length,
          "categories...",
        );
        const serviceResponses = await Promise.allSettled(
          activeCategories.map((category) => {
            console.log(
              `[Categories] Fetching subservices for category: ${category.name} (${category.id})`,
            );
            return api.get(
              API_ENDPOINTS.service.subservicesByCategory(category.id),
            );
          }),
        );
        ...
        const apiCards = serviceResponses.flatMap((response, index) => {
          if (response.status !== "fulfilled") {
            ...
            console.warn(
              `[Categories] Failed to fetch subservices for category: ${currentCategory?.name ?? "unknown"} (${currentCategory?.id ?? "n/a"})`,
            );
            return [];
          }

          const currentCategory = activeCategories[index];
          const subserviceRows = toRows(response.value.data);
          ...
          return subserviceRows
            .filter((row) => {
              ...
              if (!isActive) {
                console.log(
                  `[Categories] → Skipping inactive subservice: ${row.subservice_name ?? row.name}`,
                );
              }
              return isActive;
            })
            .map((row, rowIndex) => {
              ...
              const subserviceId = String(
                row.subservice_id ??
                  row.id ??
                  `${currentCategory.id}-${rowIndex}`,
              ).trim();
              ...
              const card: ServiceCard = {
                ...
                description: String(
                  row.description ?? "Explore vendors offering this service",
                ),
                image:
                  typeof row.icon_url === "string" && row.icon_url.trim()
                    ? row.icon_url
        ...
        console.log(
          "[Categories] Total subservices loaded from API:",
          apiCards.length,
        );
        ...
        console.error(
          "[Categories] Error loading services from API:",
          errorMessage,
          error,
        );
        ...
        if (isMounted) {
          setLoadError(
            "Unable to sync services from server, showing saved services.",
          );
          console.warn(
            "[Categories] Using fallback hardcoded services due to API error",
          );
          setAllCards(CANONICAL_SERVICE_CARDS);
    ...
    () =>
      allCards.map((card) => {
        ...
        return {
          ...card,
          localImage:
            LOCAL_TITLE_IMAGES[titleKey] ??
            LOCAL_CATEGORY_IMAGES[card.categoryId],
        };
      }),
    [allCards],
  );
  ...
  const visibleCards = useMemo(() => {
    const baseCards =
      activeService === "all"
        ...
        : cardsWithLocalFallback.filter(
            (card) => card.categoryId === activeService,
          );
            ...
            >
              <ThemedText
                style={[
                  ...
                  activeService === "all" ? styles.serviceTextActive : null,
                ]}
                numberOfLines={1}
              >
                ...
                >
                  <ThemedText
                    style={[
                      styles.serviceText,
                      { color: palette.subtext },
                      isActive ? styles.serviceTextActive : null,
                    ]}
                    numberOfLines={1}
                  >
                    {service.name} ({count})
          ...
          >
            {isLoading ? (
              <View style={styles.loadingWrap}>
                ...
                <ThemedText
                  style={[styles.loadingText, { color: palette.subtext }]}
                >
                  Loading services...
                </ThemedText>
              </View>
              ...
              >
                ...
                <ThemedText
                  style={[styles.emptyStateText, { color: palette.subtext }]}
                >
                  {loadError ||
                    "Try another service type or different search text."}
                </ThemedText>
              </View>
            ) : (
