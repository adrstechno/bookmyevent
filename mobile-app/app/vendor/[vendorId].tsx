...
export default function VendorDetailScreen() {
  ...
  const handleBookNow = (packageItem?: VendorPackage) => {
    if (!vendorId) {
      return;
    }

    router.push({
      pathname: "/book/[vendorId]",
      params: {
        vendorId,
        vendorName: vendor?.businessName ?? heading,
        ...(packageItem
          ? {
              packageId: String(packageItem.packageId),
  ...
  const imageSource = vendor?.profileUrl
    ? { uri: vendor.profileUrl }
    : FALLBACK_IMAGE;
        ...
        <FadeInView delay={80} distance={8} style={styles.body}>
          {loading ? (
            <View style={styles.stateWrap}>
              ...
              <ThemedText
                style={[styles.stateText, { color: palette.subtext }]}
              >
            ...
            >
              <ThemedText style={[styles.stateTitle, { color: palette.text }]}>
            ...
            >
                  ...
                  <View style={styles.heroBadgesRow}>
                    ...
                    {vendor.experienceYears && (
                      <View style={styles.experienceBadge}>
                        ...
                        <ThemedText style={styles.experienceBadgeText}>
              ...
              >
                ...
                <ThemedText
                  style={[styles.aboutText, { color: palette.subtext }]}
                >
                  {vendor.description ||
                    "Professional event services provider dedicated to making your special moments unforgettable."}
                </ThemedText>
              </View>
              ...
              >
                <View style={styles.sectionHeader}>
                  ...
                  <ThemedText
                    style={[styles.packageCount, { color: palette.subtext }]}
                  >
                    ({packages.length}{" "}
              ...
              {packages.length > 0 && (
                ...
                >
                  ...
                  <ThemedText style={styles.mainBookButtonText}>
                    Book Now
                  </ThemedText>
                </Pressable>
              )}
