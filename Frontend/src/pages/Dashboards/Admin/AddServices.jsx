            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div className="mt-4 md:mt-0 flex items-center justify-center gap-3 ">
                <button
                  ...
                  className="bg-[#3c6e71] hover:bg-[#284b63] text-white lg:px-6 lg:py-2 md:px-4 md:py-2 px-3 py-1 rounded-lg font-medium transition-colors flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className="bg-gray-500 hover:bg-gray-600 md:px-4 md:py-2 text-white lg:px-6 lg:py-2 px-3 py-2 rounded-lg font-medium transition-colors flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        >
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="flex-1 border border-red-400 text-red-500 hover:bg-red-500 hover:text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-1"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
