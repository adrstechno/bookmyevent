...
const CategoryTemplate = ({
  ...
  return (
    <div className="w-full bg-gray-50 flex flex-col">
      ...
      {/* ================= FEATURED WORK - IMPROVED ================= */}
      <div className="relative bg-gradient-to-br from-[#284b63] via-[#3c6e71] to-[#284b63] py-24 overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-200 text-lg max-w-2xl mx-auto">
              Showcasing our best {categoryTitle.toLowerCase()} projects
            </p>
          </motion.div>
                ...
                <div className="relative h-72 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <div className="flex items-center gap-2 mb-2">
                      <FiStar className="text-[#f9a826]" />
                      <span className="text-sm font-semibold">Premium Project</span>
                    </div>
                    <h3 className="text-2xl font-bold mb-2">
                      {categoryTitle} Showcase {n}
                    </h3>
                    <p className="text-gray-200 text-sm">
                      Exceptional {categoryTitle.toLowerCase()} event executed with perfection
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-1">
                        <FiStar className="text-[#f9a826] fill-[#f9a826]" />
                        <FiStar className="text-[#f9a826] fill-[#f9a826]" />
                        <FiStar className="text-[#f9a826] fill-[#f9a826]" />
                        <FiStar className="text-[#f9a826] fill-[#f9a826]" />
                        <FiStar className="text-[#f9a826] fill-[#f9a826]" />
                    ...
                    <button className="px-4 py-2 bg-[#3c6e71] text-white rounded-lg text-sm font-semibold hover:bg-[#2f5b60] transition-colors">
                      View Details
                    </button>
                  </div>
                </div>
