 ...
 return (
  <>
    <div
      ...
      style={{ backgroundImage: "url('https://cdn.pixabay.com/photo/2016/11/23/17/56/wedding-1854074_1280.jpg')" }}
    >
      {/* Overlay (optional, for better readability) */}
      <div className="absolute inset-0 bg-black/40"></div>

      {/* Login Card */}
<div className="relative w-full max-w-md bg-white/10 backdrop-blur-md rounded-xl shadow-2xl p-8 mx-4">
        {/* Header */}
